$(document).ready(function () {
    ...
    $('.slick-room').slick({
      ...
      touchThreshold : 100,
        ...
        slidesToScroll: 3,
      centerMode: true,
      nextArrow: '<button class="slick-next px-2  bg-transparent"><i class="bi bi-chevron-right text-white next"></i></button>',
      prevArrow: '<button class="slick-prev px-2  bg-transparent"><i class="bi bi-chevron-left text-white prev"></i></button>',
        responsive: [{
                breakpoint: 1024,
                settings: {
                    slidesToShow: 3,
